...
time.sleep(x)
#departure
a = driver.find_element(By.XPATH,'//*[@id="flight_by_route_from"]')
a.send_keys("dxb")
...
time.sleep(5)
#arrival
a = driver.find_element(By.XPATH,'//*[@id="flight_by_route_to"]')
a.send_keys("cdg")
ActionChains(driver).click(a).perform()
time.sleep(5)
a.send_keys(Keys.ENTER)
...
time.sleep(5)
#search
a = driver.find_element(By.XPATH,'/html/body/div[1]/div/div/div[1]/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div/div/div/div[2]/div/div[3]/button')
ActionChains(driver).click(a).perform()
time.sleep(100)